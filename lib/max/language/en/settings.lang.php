...
$GLOBALS['strDeliveryCaching'] = "Ad Delivery Cache Settings";
$GLOBALS['strDeliveryCacheLimit'] = "Time Between Ad Cache Updates (seconds)";
$GLOBALS['strDeliveryCacheStore'] = "Ad Delivery Cache Store Type";
$GLOBALS['strDeliveryAcls'] = "Evaluate Ad delivery limitations during delivery";
$GLOBALS['strDeliveryAclsDirectSelection'] = "Evaluate Ad delivery limitations for direct selected ads";
...
$GLOBALS['strGlobalDefaultBannerUrl'] = "Global default Ad Image URL";
...
$GLOBALS['strShowBannerInfo'] = "Show extra Ad info on <i>Ads</i> page";
$GLOBALS['strShowCampaignPreview'] = "Show preview of all Ads on <i>Ads</i> page";
$GLOBALS['strShowBannerHTML'] = "Show actual Ad instead of plain HTML code for HTML Ad preview";
$GLOBALS['strShowBannerPreview'] = "Show Ad preview at the top of pages which deal with Ads";
$GLOBALS['strHideInactive'] = "Hide inactive items from all overview pages";
$GLOBALS['strGUIShowMatchingBanners'] = "Show matching Ads on the <i>Linked Ad</i> pages";
$GLOBALS['strGUIShowParentCampaigns'] = "Show parent campaigns on the <i>Linked Ad</i> pages";
...
$GLOBALS['strDefaultBannerWeight'] = "Default Ad Weight";
...
$GLOBALS['strBannerDelivery'] = "Ad Delivery Settings";

// Banner Logging Settings
$GLOBALS['strBannerLogging'] = "Ad Logging Settings";
$GLOBALS['strLogAdRequests'] = "Log a request every time a Ad is requested";
$GLOBALS['strLogAdImpressions'] = "Log an impression every time a Ad is viewed";
$GLOBALS['strLogAdClicks'] = "Log a click every time a viewer clicks on a Ad";
...
$GLOBALS['strPreventLogging'] = "Block Ad Logging Settings";
...
$GLOBALS['strBannerStorage'] = "Ad Storage Settings";
