...
$GLOBALS['strChooseTypeOfBannerInvocation'] = "Please choose the type of Ad invocation";
...
$GLOBALS['strInvocationWhat'] = "Ad selection";
$GLOBALS['strInvocationCampaignID'] = "Campaign";
$GLOBALS['strInvocationTarget'] = "Target frame";
$GLOBALS['strInvocationSource'] = "Source";
$GLOBALS['strInvocationWithText'] = "Show text below Ad";
$GLOBALS['strInvocationDontShowAgain'] = "Don't show the Ad again on the same page";
$GLOBALS['strInvocationDontShowAgainCampaign'] = "Don't show a Ad from the same campaign again on the same page";
$GLOBALS['strInvocationTemplate'] = "Store the Ad inside a variable so it can be used in a template";
$GLOBALS['strInvocationBannerID'] = "Ad ID";
$GLOBALS['strInvocationComments'] = "Include comments";

// Iframe
$GLOBALS['strIFrameRefreshAfter'] = "Refresh after";
$GLOBALS['strIframeResizeToBanner'] = "Resize iframe to Ad dimensions";
