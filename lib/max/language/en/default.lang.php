...
$GLOBALS['strBanners'] = "Configure Ads";
...
$GLOBALS['strZonesSearchTitle'] = "Search zones and walls by name";
$GLOBALS['strNoWebsitesAndZones'] = "No walls and zones";
...
$GLOBALS['strEditWebsite'] = "Edit wall";
...
$GLOBALS['strAnonymous'] = "Hide the advertiser and walls of this campaign.";
...
// Banners (General)
$GLOBALS['strBanner'] = "Configure Ad";
$GLOBALS['strBanners'] = "Configure Ad";
$GLOBALS['strAddBanner'] = "Add new Ad";
$GLOBALS['strAddBanner_Key'] = "Add <u>n</u>ew Ad";
$GLOBALS['strBannerToCampaign'] = "to campaign";
$GLOBALS['strShowBanner'] = "Show Ad";
$GLOBALS['strBannerProperties'] = "Ad Properties";
$GLOBALS['strBannerHistory'] = "Ad History";
$GLOBALS['strNoBanners'] = "There are currently no banners defined for this campaign.";
$GLOBALS['strNoBannersAddCampaign'] = "There are currently no banners defined, because there are no campaigns. To create a Ad, <a href='campaign-edit.php?clientid=%s'>add a new campaign</a> first.";
$GLOBALS['strNoBannersAddAdvertiser'] = "There are currently no banners defined, because there are no advertisers. To create a Ad, <a href='advertiser-edit.php'>add a new advertiser</a> first.";
$GLOBALS['strConfirmDeleteBanner'] = "Deleting this banner will also remove its statistics.\\nDo you really want to delete this Ad?";
$GLOBALS['strConfirmDeleteBanners'] = "Deleting these banners will also remove their statistics.\\nDo you really want to delete the selected Ad?";
$GLOBALS['strShowParentCampaigns'] = "Show parent campaigns";
$GLOBALS['strHideParentCampaigns'] = "Hide parent campaigns";
$GLOBALS['strHideInactiveBanners'] = "Hide inactive Ads";
$GLOBALS['strInactiveBannersHidden'] = "inactive Ad(s) hidden";
...
// Banner Preferences
$GLOBALS['strBannerPreferences'] = "Ad Preferences";
...
$GLOBALS['strAllowedBannerTypes'] = "Allowed Ad Types";
$GLOBALS['strTypeSqlAllow'] = "Allow SQL Local Ads";
$GLOBALS['strTypeWebAllow'] = "Allow Webserver Local Ads";
$GLOBALS['strTypeUrlAllow'] = "Allow External Ads";
$GLOBALS['strTypeHtmlAllow'] = "Allow HTML Ads";
$GLOBALS['strTypeTxtAllow'] = "Allow Text Ads";

// Banner (Properties)
$GLOBALS['strChooseBanner'] = "Please choose the type of the Ad";
$GLOBALS['strMySQLBanner'] = "Upload a local Ad to the database";
$GLOBALS['strWebBanner'] = "Upload a local Ad to the webserver";
$GLOBALS['strURLBanner'] = "Link an external Ad";
$GLOBALS['strHTMLBanner'] = "Create an HTML Ad";
$GLOBALS['strTextBanner'] = "Create a Text Ad";
$GLOBALS['strAlterHTML'] = "Alter HTML to enable click tracking for:";
$GLOBALS['strIframeFriendly'] = "This Ad can be safely displayed inside an iframe (e.g. is not expandable)";
$GLOBALS['strUploadOrKeep'] = "Do you wish to keep your <br />existing image, or do you <br />want to upload another?";
$GLOBALS['strNewBannerFile'] = "Select the image you want <br />to use for this Ad<br /><br />";
...
$GLOBALS['strBannerWeight'] = "Ad weight";
$GLOBALS['strAdserverTypeGeneric'] = "Generic HTML Ad";
...
// Banner (advanced)
$GLOBALS['strBannerPrependHTML'] = "Always prepend the following HTML code to this Ad";
$GLOBALS['strBannerAppendHTML'] = "Always append the following HTML code to this Ad";
...
// Website
$GLOBALS['strAffiliate'] = "Wall";
$GLOBALS['strAffiliates'] = "Walls";
$GLOBALS['strAffiliatesAndZones'] = "Walls & Zones";
$GLOBALS['strAddNewAffiliate'] = "Add new wall";
$GLOBALS['strAffiliateProperties'] = "Wall Properties";
$GLOBALS['strAffiliateHistory'] = "Wall History";
$GLOBALS['strNoAffiliates'] = "There are currently no walls defined. To create a zone, <a href='affiliate-edit.php'>add a new wall</a> first.";
$GLOBALS['strConfirmDeleteAffiliate'] = "Do you really want to delete this wall?";
$GLOBALS['strConfirmDeleteAffiliates'] = "Do you really want to delete the selected walls?";
$GLOBALS['strInactiveAffiliatesHidden'] = "inactive wall(s) hidden";
$GLOBALS['strShowParentAffiliates'] = "Show parent walls";
$GLOBALS['strHideParentAffiliates'] = "Hide parent walls";

// Wall (properties)
$GLOBALS['strWall'] = "Wall";
$GLOBALS['strWallURL'] = "Wall URL";
...
// Wall (properties - payment information)
$GLOBALS['strPostcode'] = "Postcode";
$GLOBALS['strCountry'] = "Country";

// Wall (properties - other information)
$GLOBALS['strWallZones'] = "Wall's zones";
...
$GLOBALS['strNoZones'] = "There are currently no zones defined for this wall.";
$GLOBALS['strNoZonesAddWall'] = "There are currently no zones defined, because there are no walls. To create a zone, <a href='affiliate-edit.php'>add a new wall</a> first.";
...
$GLOBALS['strZonesOfWall'] = 'in'; //this is added between page name and wall name eg. 'Zones in www.example.com'
...
$GLOBALS['strSelectPublisher'] = "Select Wall";
...
$GLOBALS['strPublisherDistribution'] = "Wall Distribution";
...
$GLOBALS['strDistributionHistoryWall'] = "Distribution history (Wall)";
...
$GLOBALS['strAllPublishers'] = "All walls";
$GLOBALS['strAnonPublishers'] = "Anonymous walls";
...
$GLOBALS['strInvalidWallURL'] = "Invalid Wall URL";
...
$GLOBALS['strChannelToWall'] = "to wall";
$GLOBALS['strNoChannels'] = "There are currently no targeting channels defined";
$GLOBALS['strNoChannelsAddWall'] = "There are currently no targeting channels defined, because there are no walls. To create a targeting channel, <a href='affiliate-edit.php'>add a new wall</a> first.";
...
$GLOBALS['strChannelsOfWall'] = 'in'; //this is added between page name and wall name eg. 'Targeting channels in www.example.com'
...
$GLOBALS['strWallHasBeenAdded'] = "Wall <a href='%s'>%s</a> has been added, <a href='%s'>add a zone</a>";
$GLOBALS['strWallHasBeenUpdated'] = "Wall <a href='%s'>%s</a> has been updated";
$GLOBALS['strWallHasBeenDeleted'] = "Wall <b>%s</b> has been deleted";
$GLOBALS['strWallsHaveBeenDeleted'] = "All selected wall have been deleted";
...
$GLOBALS['strZoneHasBeenMoved'] = "Zone <b>%s</b> has been moved to wall <b>%s</b>";
